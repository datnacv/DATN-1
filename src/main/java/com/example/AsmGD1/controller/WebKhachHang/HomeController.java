...
public class HomeController {
    ...
    public String home(Model model, Authentication authentication) {
        ...
        model.addAttribute("summerProducts", khachhangSanPhamService.getNewProducts()); // Thay bằng getSummerProducts() nếu có
        model.addAttribute("bestsellerProducts", khachhangSanPhamService.getNewProducts()); // Thay bằng getBestsellerProducts() nếu có

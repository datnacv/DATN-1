...
import com.example.AsmGD1.type.CreatePaymentLinkRequestBody;
...
@RestController
@RequestMapping("/kh-order")
public class KHOrderControllerPayOS {
    private final PayOS payOS;

    public KHOrderControllerPayOS(PayOS payOS) {
        super();
        this.payOS = payOS;
    }

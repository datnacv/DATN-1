...
import com.example.AsmGD1.Service.GuiMailService;
import com.example.AsmGD1.Service.PhieuGiamGiaCuaNguoiDungService;
import com.example.AsmGD1.entity.NguoiDung;
import com.example.AsmGD1.entity.PhieuGiamGia;
import com.example.AsmGD1.repository.PhieuGiamGiaRepository;
...
public class PhieuGiamGiaController {
    ...
    public String list(@RequestParam(required = false) String search,
        ...
        Page<PhieuGiamGia> pageResult = phieuGiamGiaRepository.findAll(
                com.example.AsmGD1.specification.PhieuGiamGiaSpecification.filter(search, type, status, from, to), pageable
        );
